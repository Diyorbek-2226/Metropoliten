...
export default function Footer() {
  return (
    <footer className="footer bg-[#2962D7] text-white py-6">
      <div className="footer_box flex flex-col  sm:flex-row items-center sm:justify-between space-y-6 sm:space-y-0 px-4 sm:px-0">
        ...
        {/* Center Text Section */}
       <div className="container mx-auto w-full sm:w-4/5 text-center">
  <div className="footer_title pt-4 pb-4">
    ...
    <p className="mt-4 mb-4 text-sm sm:text-base leading-relaxed max-w-3xl mx-auto">
