      ...
      <div className="container w-full grid place-items-center h-full">  
        <form className="Form-submit rounded-[40px] text-white font-mono w-[580px] bg-opacity-80 ">  
          <div className=''>  
            ...
            <div className="mt-4 ">  
              <label className="block mt-1 mb-1" htmlFor="username">JSHSHIR</label>  
              <input className="focus:bg-slate-600 block w-full p-2 rounded" id="username" placeholder="JSHSHIR" type="text" />  
            </div>  
            <div className="mt-4">  
              <label className="block mt-1 mb-1" htmlFor="password">Pasport seriya</label>  
              <input className="focus:bg-slate-600 block w-full p-2 rounded" id="password" placeholder="Pasport seriya" type="password" />  
